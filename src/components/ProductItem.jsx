    ...
    <>
      <div className="flex flex-col gap-4 p-3 bg-gray-300 dark:bg-gray-800 border border-gray-400 dark:border-gray-600 rounded-lg">
        <div className="flex-1 space-y-2">
          <figure className="w-full h-60 bg-gray-50 border border-gray-400 dark:border-gray-600 p-6 rounded-lg">
            <img
          ...
          <div className="">
            Price: <span className="text-sky-500 font-bold">${price}</span>
          </div>
        ...
        <button
          ...
          className="p-3 font-bold capitalize bg-sky-400 text-gray-50 dark:bg-sky-600 rounded-lg hover:underline"
          type="button"
        >
          add to cart
        </button>
